        ...
        for row in 0..self.height {
            for col in 0..self.width {
                ...
                let next_cell = match (cell, live_neighbours) {
                    // Rule 1: any live cell w/ < 2 live neighbours dies
                    (Cell::Alive, x) if x < 2 => Cell::Dead,
                    // Rule 2: any live cell w/ 2 or 3 live neighbours lives
                    (Cell::Alive, x) if (x == 2 || x == 3) => Cell::Alive,
                    // Rule 3: Any live cell w/ > 3 live neighbours dies
                    (Cell::Alive, x) if x > 3 => Cell::Dead,
                    // Rule 4: Any dead cell w/ 3 live neighbours lives
